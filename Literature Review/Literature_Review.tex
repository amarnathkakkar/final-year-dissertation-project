...
In contrast, traditional methods of teaching centre on instructors who have control over class content and the learning process, whereas online resources, provide a leaner-centred, self-paced learning environment \citep{Zhang2004}. \citet{Zhang2004} argue that e-learning could be used as an alternative to traditional classroom learning. Nevertheless, using e-learning to complement the learning process can make learning more effective and improve the learning experience \citep{Zhang2004, Concannon2005}
...
Many researchers have looked into the factors that influence learning \citep{roungas2015}. Below are some factors that influence learning in a positive way, and how these are implemented in games. \citet{roungas2015} argue that the following factors are important when designing serious games.
...
Fun is another source of motivation, and playing games is naturally a fun and pleasurable activity \citep{Prensky2001}. Research has shown that fun and enjoyment are important to the learning process, as leaners can be more motivated and willing to learn \citep{Bisson1996, Cordova1996}. Learners' enjoyment of the game has also been show to improve learners' performance, with regards to acquiring knowledge \citep{giannakos2013}.
...
Repetition is very common in video games. It allows players to learn, memorise and potentially master some rules or controls of the game. Once players are familiar with these skills, the game then introduces a new problem, which requires players to integrate their old skills with new ones \citep{Gee2003}. These new problems are practised until a  problem requiring a different solution comes along. Then this cycle is repeated throughout the game.

However, repetition needs to be managed, as it could lead to boredom. To avoid this, \citet{roungas2015} suggest modifying the content of the task after each repetition. This can be achieved in games by slowly introducing new rules or controls that build upon previous game knowledge, or, by framing the task in a different scenario. \citet{roungas2015} also suggested managing how frequent the task is presented. A task repeated too often could lead to boredom, or a task repeated at very long time intervals, could reduce the benefits from repetition.


\subsubsection{Reward/Punishment}

Reward and punishment have a few different impacts. Firstly, rewards allow a learner to link learning with something pleasant \citep{roungas2015}. Secondly, rewards are form of extrinsic motivation, that is, learners are motivated by factors external to themselves. For example, achieving high grades, winning trophies or recognition by peers are all forms of extrinsic motivation. Thus attempting to seek such rewards represents learners with a challenge, and challenge is seen as a key component for engagement \citep{Malone1987}.

Games can dish out rewards and punishment in a variety of different ways. 

However, the relevancy and frequency of rewards needs to be managed. The type of reward should depend on the targeted audience. Like repetition, the frequency of an award is also important. Rewarding too often can cause players to lose interest, or rewarding very little can lead players to lose motivation to play \citep{roungas2015}.

%Secondly, rewards and punishment bring about a form of challenge. Learners try to seek rewards and avoid punishment. Challenge is seen as a key component in engagement \citep{Malone1987}. 

Why is this important for learning?
How do games implement this?
