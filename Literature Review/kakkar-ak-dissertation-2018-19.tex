...
%This section will be relatively short. It should introduce the reader to the problem that is to be tackled and provide a brief indication of the context within which the problem exists. The most important part is an explanation why the problem is worthy of study. It should also include an outline of the structure of the dissertation, providing a framework for the reader.
...
%Whilst the majority of research on video games focused on the negative impacts from playing, research has now shifted its focus to the positive impacts. This includes using games as educational tools. 
...
%Develop educational game
%Issue with students dropping out
%Evidence of learning there
%but Effectiveness undiscovered
...
%The literature review highlights two areas of study to optimise the aerodynamic performance of a flying wing UAV. As the Skyseeker is currently in the design phase, the first approach of pre design improvements will be considered, in order to improve the aerodynamic performance and stall behaviour.
...
%The following sections of the literature review will be considered; benefits of educational games; issues of teaching iterative and conditional control structures; the elements from the example of educational games that had a positive impact, and finally educational game design.
...
%if the game contains many easily identifiable problems, any feedback received is likely to focus on those issues.
%Because of this, the value of the feedback received has a clear correlation with the number of easily identifiable problems that have been fixed beforehand.
...
%The game was tested throughout development to ensure that all functionality worked as expected, and that graphics were represented correctly. This was conducted mainly in Safari. Once implementation was complete, and a game was produced as per the requirements and design

%Throughout development, the game was tested to ensure that all functionality worked as expected and that the graphics were represented correctly. This was carried out mainly in Safari and Google Chrome. 

%, the game was thoroughly tested through numerous playthroughs and some specific test cases. Once testing was completed, the game underwent initial feedback and improvements. This was done through a handful of participants using the think-aloud protocol. When final improvements were made to the game. The game was now ready for user testing. The aim of the user testing was designed to assess the learning, engagement and motivation of users from playing.
...
%The game was tested throughout its development, to ensure that all functionality worked as expected and that the graphics were represented correctly. During development, the game was mainly tested in Safari and Chrome. 

%The final game was thoroughly tested 

%What testing I conducted
%Why I didnt follow a formal spec
%How I tested
%Results
...
%Once the game was implemented according to the requirements specification and design. 
...
%General participant info - age, experience, motivation
...
%How many levels did they complete
...
%Interest pretest-posttest
%Complex ICS
%Complex ICS through game?
...
%longitudinal study - how much knowledge retained
...
\begin{tabular}{|l|l|l|l|l|l| p{2cm} | p{2cm} | p{1cm} | p{1cm} | p{2cm} | p{7cm}|} 
 ...
 F&4&	7&	3&	5&	5&	if, if else&	nested for, for&	Yes&	Yes&	Somewhat&	The tutorial was long and I didn't want to read multitudes of text. Using arrows and small messages that point to various parts of the UI instead of a big paragraph would have been appreciated (example: coolors.co). The IDE was pretty nice, Alt+upp/down arrow key to move lines of text was nice but the tab could have been adjusted to match the current scope. The game itself was pretty cool although I think having fixed lines of code that the player is not able to change would have added a level of difficulty, as it forces iterative over purely procedural programming. A tips section would have been cool in case there was a difficult programming puzzle, and an introduction to each function would have been better than needing to click "Help" to find out shooting an enemy is a thing. Overall pretty dope game.
\\ \hline
G&4&	8&	3&	3&	4&	if, if else&	nested for, for&	Yes&	Yes&	Somewhat&	Help section was very useful.
\\ \hline
H&2&	5&	5&	2&	2&	if, if else&	nested for, for&	No&	Maybe&	Somewhat&	Alright game
\\ \hline
...
I&5&	8&	2&	3&	4&	if, if else&	nested for, for&	No&	Maybe&	Yes&	Should force user to use for loops and if statements
\\ \hline
J&4&	7&	4&	4&	4&	if, if else&	nested for, for&	Yes&	Yes&	Somewhat &	
\\ \hline
K&2&	3&	5&	2&	2&	if, if else&	nested for, for&	Maybe&	Yes&	Somewhat&	It was very helpful to learn the iteration and conditional but it does get boring after a while.
\\ \hline

L&4&	3&	4&	4&	3&	if&	if&	Maybe&	Yes&	Somewhat&	Good game, fun to play, really made me want to learn more about programming
\\ \hline
M&1&	1&	5&	1&	1&	if&	for&	No&	Yes&	No&	What I was supposed to do was unclear. Though I was told to get the player to the red square, I couldn't see the red player until I clicked run. The second time I got to click run, it wouldn't work
\\ \hline
N&3&	4&	4&	4&	3&	if, if else&	nested for, for&	Maybe&	Yes&	Not very	&
\\ \hline
O&5&	7&	1&	5&	5&	if, if else&	nested for, for&	Yes&	Yes&	Yes&	Sometimes I had to restart because of the website not responding after clicking the 'run' button. Other than that the game seems both helpful and makes the player want to learn more about iterative and conditional statements!
\\ \hline
...
\begin{tabular}{|l|l|l|l|l|l| p{2cm} | p{2cm} | p{1cm} | p{1cm} | p{2cm} | p{7cm}|} 
 \hline        Participant & Q1 & Q2 & Q3 & Q4 & Q5 & Q6 & Q7 &Q8 &Q9 & Q10&Q11 \\ \hline
 P&4&	8&	3&	3&	3&	if else&	for&	Maybe&	Maybe&	Yes&	Perhaps the text could have been more concise during the step to step guide at the beginning of the game.
\\ \hline
Q&4&	5&	5&	4&	3&	nested for, if&	nested for, if else&	Yes	&Yes&	Somewhat&	was hard but has made me interested
\\ \hline
R&2&	2&	4&	4&	4&	if, if else&	nested for, for&	No&	Yes&	Yes&	\\ \hline
S&5&	7&	3&	3&	3&	if, if else&	nested for, for&	Yes	&Maybe&	Not very&	\\ \hline
T&3&	5&	2&	4&	2&	nested for, if, if else, for&	if, nested for, if else, for&	Maybe&	Yes&	Not very&	\\ \hline
U&4&	8&	4&	3&	5&	if, if else&	nested for, for&	No&	Yes&	Somewhat&	\\ \hline
