...
The requirements are split into functional and non-functional sections, and each requirement is given an importance rating of: high, medium or low, which refer to being essential, conditional and optional for the system respectively. 
...
\begin{enumerate}[label=3.2.\arabic*]
  ...
  \item \textbf{Game may save players progress.} Saving game state would allow players to leave the game for any reason, and return any time they wish. \newline Priority: Low
...
\section{Game Aesthetics} %How it will look ()
\section{Game Dynamics} %How it interacts (How the user interacts)
...
\section{Player Command Functions}
