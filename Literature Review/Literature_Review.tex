...
These control structures are likely to be taught in larger introductory units, which cover a wide range of fundamental concepts. For example, at the University of Bath, conditional and iterative structures are taught in semester 1 of year 1 of a computer science undergraduates degree \citep{bath}. Iterative and conditional constructs are very simple and very fundamentals. So, they are probably introduced and taught at the start of a course and for only brief period. They then probably are used and built on throughout the rest of the course to learn more complex topics and create more complex programs. Thus, I will look at some solutions of teaching introductory concepts.
