...
%University logo
    ...
    \vspace{2.5cm}
%Thesis title
    {\uppercase{\Large \textbf{An Investigation into the Effectiveness of an Educational Game for Teaching Iterative and Conditional Control Structures} \par}} %Development of an Educational Game to Teach Conditional and Iterative Control Structures
    \vspace{3cm}
%Author's name
...
%    {\uppercase{\large {Submitted in partial fulfilment for the degree of masters in aerospace engineering} \par}}
    \vspace{0.8cm}
%%Author's name
    {\LARGE An Investigation into the Effectiveness of an Educational Game for Teaching Iterative and Conditional Control Structures \par}
    \vspace{1cm}	
...
\subsection{Effectiveness for Learning} %Effectiveness of Learning through Games
...
The source control software used for this study was GitHub. Source control has many features that are useful for when developing software. The functionality GitHub source control provides is the ability to, save code locally and in the cloud, which is often backed up by security, manage code updates, 
...
\section{Character-Function Interaction}
