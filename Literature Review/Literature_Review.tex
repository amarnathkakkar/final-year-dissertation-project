...
Teaching introductory programming topics to novice programmers is regarded as a complex issue \citep{Koulouri2014}. For leaners, the overhead of learning the syntax and semantics of a language at the same time, difficulties in combining new and previous knowledge, and developing their problem-solving skills, all add to the complexity of learning how to program \citep{Koulouri2014}. 


For University students, there is a concern for high failure rates in introductory units, which is potentially leading to high drop out rates in computer science courses \citep{Koulouri2014}. \citep{Koulouri2014} carried out a 4-year longitudinal study. 
