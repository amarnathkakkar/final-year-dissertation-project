...
Figure \ref{fig:User-Interface-Design} shows the design layout of the game. The elements in the design were selected in order to satisfy the requirements. The description and purpose of each element is explained below:
